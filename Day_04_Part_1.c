...
int validCount;
  ...
  for (i = validCount = 0; '*' != passportList[i][0]; ++i) {
    for (j = 0, recordCount = 0; '\0' != passportList[i][j];) {
      if ((('b' == passportList[i][j]) && ('y' == passportList[i][j + 1]) && ('r' == passportList[i][j + 2])) ||
          (('i' == passportList[i][j]) && ('y' == passportList[i][j + 1]) && ('r' == passportList[i][j + 2])) ||
          (('e' == passportList[i][j]) && ('y' == passportList[i][j + 1]) && ('r' == passportList[i][j + 2])) ||
          (('h' == passportList[i][j]) && ('g' == passportList[i][j + 1]) && ('t' == passportList[i][j + 2])) ||
          (('h' == passportList[i][j]) && ('c' == passportList[i][j + 1]) && ('l' == passportList[i][j + 2])) ||
          (('e' == passportList[i][j]) && ('c' == passportList[i][j + 1]) && ('l' == passportList[i][j + 2])) ||
          (('p' == passportList[i][j]) && ('i' == passportList[i][j + 1]) && ('d' == passportList[i][j + 2]))) {
         ++recordCount;
      }
