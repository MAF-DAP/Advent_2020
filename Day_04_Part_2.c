...
#define nodoTest
#ifdef  doTest
#define PASSPORTWIDTH 79
char passportList[][PASSPORTWIDTH + 1] = {
...
//              11111111112222222222333333333344444444445555555555666666666677777777778
   ...
   ,  "*"
#else
#define PASSPORTWIDTH 100
char passportList[][PASSPORTWIDTH] = {
...
int invalidFlag;
  ...
  for (i = validCount = 0; '*' != passportList[i][0]; ++i) {
    for (j = invalidFlag = recordCount = 0; '\0' != passportList[i][j];) {
      if (('c' == passportList[i][j]) && ('i' == passportList[i][j + 1]) && ('d' == passportList[i][j + 2])) {
//skip
      }
      else if (('b' == passportList[i][j]) && ('y' == passportList[i][j + 1]) && ('r' == passportList[i][j + 2])) {
        for (k = (j += 4), n = 0; ('0' <= passportList[i][j]) && ('9' >= passportList[i][j]); ++j) {  n = (n * 10) + passportList[i][j] - '0';  }
        if (((k + 4) != j) || (1920 > n) || (2002 < n)) {
          invalidFlag = 1;
        }
        ++recordCount;
      }
      else if (('i' == passportList[i][j]) && ('y' == passportList[i][j + 1]) && ('r' == passportList[i][j + 2])) {
        for (k = (j += 4), n = 0; ('0' <= passportList[i][j]) && ('9' >= passportList[i][j]); ++j) {  n = (n * 10) + passportList[i][j] - '0';  }
        if (((k + 4) != j) || (2010 > n) || (2020 < n)) {
          invalidFlag = 1;
        }
        ++recordCount;
      }
      else if (('e' == passportList[i][j]) && ('y' == passportList[i][j + 1]) && ('r' == passportList[i][j + 2])) {
        for (k = (j += 4), n = 0; ('0' <= passportList[i][j]) && ('9' >= passportList[i][j]); ++j) {  n = (n * 10) + passportList[i][j] - '0';  }
        if (((k + 4) != j) || (2020 > n) || (2030 < n)) {
          invalidFlag = 1;
        }
        ++recordCount;
      }
      else if (('h' == passportList[i][j]) && ('g' == passportList[i][j + 1]) && ('t' == passportList[i][j + 2])) {
        for (j += 4, n = 0; ('0' <= passportList[i][j]) && ('9' >= passportList[i][j]); ++j) {  n = (n * 10) + passportList[i][j] - '0';  }
        if ('i' == passportList[i][j]) {
          if ((59 > n) || (76 < n)) {
            invalidFlag = 1;
          }
        }
      ...
      else if (('h' == passportList[i][j]) && ('c' == passportList[i][j + 1]) && ('l' == passportList[i][j + 2])) {
        if ('#' != passportList[i][j + 4]) {
          invalidFlag = 1;
        }
        else {
          for (k = (j += 5); (('0' <= passportList[i][j]) && ('9' >= passportList[i][j])) || (('a' <= passportList[i][j]) && ('f' >= passportList[i][j])); ++j) {  }
          if ((k + 6) != j) {
            invalidFlag = 1;
          }
        }
      ...
      else if (('e' == passportList[i][j]) && ('c' == passportList[i][j + 1]) && ('l' == passportList[i][j + 2])) {
        j += 4;
        if ((('a' == passportList[i][j]) && ('m' == passportList[i][j + 1]) && ('b' == passportList[i][j + 2])) ||
            (('b' == passportList[i][j]) && ('l' == passportList[i][j + 1]) && ('u' == passportList[i][j + 2])) ||
            (('b' == passportList[i][j]) && ('r' == passportList[i][j + 1]) && ('n' == passportList[i][j + 2])) ||
            (('g' == passportList[i][j]) && ('r' == passportList[i][j + 1]) && ('y' == passportList[i][j + 2])) ||
            (('g' == passportList[i][j]) && ('r' == passportList[i][j + 1]) && ('n' == passportList[i][j + 2])) ||
            (('h' == passportList[i][j]) && ('z' == passportList[i][j + 1]) && ('l' == passportList[i][j + 2])) ||
            (('o' == passportList[i][j]) && ('t' == passportList[i][j + 1]) && ('h' == passportList[i][j + 2]))) {
        }
        else {
          invalidFlag = 1;
        }
      ...
      else if (('p' == passportList[i][j]) && ('i' == passportList[i][j + 1]) && ('d' == passportList[i][j + 2])) {
        for (k = (j += 4); ('0' <= passportList[i][j]) && ('0' <= passportList[i][j]); ++j) {  }
        if ((k + 9) != j) {
          invalidFlag = 1;
        }
        ++recordCount;
      }
      for (; (' ' != passportList[i][j]) && ('\0' != passportList[i][j]); ++j) {  }
      for (; ' ' == passportList[i][j]; ++j) {  }
    }
    if ((!invalidFlag) && (7 == recordCount)) {
       ++validCount;
    }
  }
